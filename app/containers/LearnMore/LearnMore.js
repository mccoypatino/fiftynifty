                ...
                <div style={styles.container}>
                    <div>
                        ...
                        <small><p> Hints and a guide</p>
                            ...
                            <p>
                                You sign up with a name that you'd like your friends to see, and a zip code and a phone number.  If we can't figure out who your rep is, we'll ask for an address.  Click the button and we'll make the call to connect you.  That's how we keep score.<em> We use your phone number and other information purely and only to score and map progress.  It is encrypted and cannot be stolen or misused.  We will erase it at the end of each challenge.  You can call immediately or later, but the sooner you get it done, the happier you will be.
                            </em></p><em>
